window.addEventListener('load', function() {
	...
	var izvediDodaj = function(event){
		...
		<div class='opomnik senca rob'><div class='opomnik> <div class='naziv_opomnika'>" + naziv_opomnika + "</div> <div class='cas_opomnika'>Opmonik čez <span>" + cas_opomnika + "</span>sekund.</div></div>";
	}
